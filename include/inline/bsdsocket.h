...
#define gethostbyname_r(name, hp, buf, buflen, he) ({ \
  ...
  ({ \
  register struct Library * const __gethostbyname_r__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define gethostbyaddr_r(addr, len, type, hp, buf, buflen, he) ({ \
  ...
  ({ \
  register struct Library * const __gethostbyaddr_r__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define freeaddrinfo(ai) ({ \
  ...
  { \
  register struct Library * const __freeaddrinfo__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define getaddrinfo(hostname, servname, hints, res) ({ \
  ...
  ({ \
  register struct Library * const __getaddrinfo__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define gai_strerror(errnum) ({ \
  ...
  ({ \
  register struct Library * const __gai_strerror__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
...
#define getnameinfo(sa, salen, host, hostlen, serv, servlen, flags) ({ \
  ...
  ({ \
  register struct Library * const __getnameinfo__bn __asm("a6") = (struct Library *) (BSDSOCKET_BASE_NAME);\
